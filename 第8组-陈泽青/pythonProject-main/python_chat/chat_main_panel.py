...
class MainPanel:
    ...
    def show_main_panel(self):
        ...
        # 设置主窗口标题
        self.main_frame.title("cat聊天室")
        # 设置主窗口颜色
        self.main_frame.configure(background="whitesmoke")#new
        # 设置关闭主窗口的回调函数
        self.main_frame.protocol("WM_DELETE_WINDOW", self.close_main_window)
        # 声明宽度，高度变量用于设置主窗口局中
        self.main_frame.iconbitmap("E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\test.ico")#new
        width = 900#new
        height = 500
        # 获取屏幕的高度，宽度
        ...
        self.p1 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包1.gif')
        self.p2 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包2.gif')
        self.p3 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包3.gif')
        self.p4 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包4.gif')
        self.p5 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包5.gif')
        self.p6 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包6.gif')
        self.p7 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包7.gif')
        self.p8 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包8.gif')
        self.p9 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包9.gif')
        self.p10 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\微信表情包10.gif')

        # 按钮图片，把图片转换为PhotoImage
        self.p11 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\表情按钮.png')
        self.p12 = PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\聊天记录按钮.png')
        ...
        # 设置文本标签和位置
        self.label1 = Label(self.main_frame, text="                                      cat聊天室欢迎您：" + self.user_name + "   "
                                                                                                      "              "
                                                                                                      "      " +
                                                  "                           ", font=("微软雅黑", 15), bg="lemonchiffon", fg="orange")
        ...
        self.friend_list = Listbox(self.main_frame, selectmode=NO, listvariable=friend_list_var,
                                   bg="honeydew", fg="#00BFFF", font=("微软雅黑", 14),
        ...
        # 显示消息的文本框
        self.message_text = Text(self.main_frame, bg="honeydew", height=1,
        ...
        numIdx = 4  # gif的帧数
        # 循环遍历动图的帧
        frames = [PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\main.gif', format='gif -index %i' % (i)) for i in range(numIdx)]
        # 创建存储gif的标签
        imgLabel = Label(self.main_frame, height=100, width=490)
        # 设置标签的位置
        imgLabel.grid(row=1, column=1, sticky=W + E + N + S, rowspan=700, padx=(0, 0), pady=(295, 330))
        ...
        # 发送消息框
        self.send_text = Text(self.main_frame, bg="honeydew", height=11, highlightcolor="white",
        ...
        button1 = Button(self.main_frame, command=lambda: self.send_message(self), text="发送", bg="#00BFFF",
                         fg="white", width=10, height=1, font=('微软雅黑', 12),relief=GROOVE)
        button1.place(x=750, y=450)

        # 设置关闭窗口按钮及位置，事件处理函数为close_main_window
        button2 = Button(self.main_frame, text="关闭", bg="white", fg="black", width=10, height=1,
                              font=('微软雅黑', 12), command=self.close_main_window,relief=GROOVE)
        button2.place(x=630, y=450)

        # 设置表情包按钮及位置，事件处理为实例方法express
        botton4 = Button(self.main_frame, command=self.express, image=self.p11, relief=FLAT, bd=0)
        botton4.place(x=205, y=325)
        ...
        botton5 = Button(self.main_frame, command=self.refurbish_user, text="刷新在线用户", bg="#00BFFF", fg="white",
                         width=13, height=1, font=('微软雅黑', 12),relief=GROOVE)
        botton5.place(x=21, y=450)
    ...
    def create_window(self):
        ...
        top1.iconbitmap("E:/third/Digital authentication/test/pythonProject-main/2/pythonProject-main/python_chat/test.ico")#new  
        # 得到屏幕宽度，高度
        ...
        # 设置文本标签
        title_lable = Label(top1, text="聊天记录", font=('黑体', 20, 'bold italic'),
                            fg="white", bg="#00BFFF")
        # 设置文本在窗口的位置
    ...
    def show_chatting_records(self):
        ...
        # 打开用户的存放聊天记录的本地文件
        f = open("E:/third/Digital authentication/test/pythonProject-main/2/pythonProject-main/chatting_records/chatting_records" + self.user_name + ".txt", 'r')
        while True:
    ...
    def clear_chatting_records(self):
        ...
        # 打开聊天记录文件，以覆盖的形式写入内容
        a = open("E:/third/Digital authentication/test/pythonProject-main/2/pythonProject-main/chatting_records/chatting_records" + self.user_name + ".txt",
                 'w')
    ...
    def sava_chatting_records(self, content):
        # 打开聊天记录文件
        a = open("E:/third/Digital authentication/test/pythonProject-main/2/pythonProject-main/chatting_records/chatting_records" + self.user_name + ".txt", 'a')
    ...
    def express(self):
        ...
        if self.ee == 0:
            ...
            self.b2.place(x=248, y=400)
            self.b3.place(x=296, y=400)
            self.b4.place(x=344, y=400)
            self.b5.place(x=392, y=400)
            self.b6.place(x=200, y=350)
            self.b7.place(x=248, y=350)
            self.b8.place(x=296, y=350)
            self.b9.place(x=344, y=350)
            self.b10.place(x=392, y=350)
    ...
    def refresh_friends(self, online_number, names):
        ...
        self.friend_list.itemconfig(0, fg="yellowgreen")  # 设置在线用户数颜色
    ...
    def show_send_message(self, user_name, content, chat_flag):
        ...
        if content == '* 系统提示: ' + user_name + ' 加入聊天室':  # 加入聊天室标记处理
            ft = tf.Font(family='微软雅黑', size=13)  # 设置字体样式和大小变量
            # 设置字体颜色样式及大小
            self.message_text.tag_config("tag_1", foreground="yellowgreen", font=ft)
        ...
        if content in self.dic:  # 判断消息是否为表情标记
            ...
            # 打开图片
            self.img1 = Image.open("E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像.png")  # 打开数据库保存的本地文件
            # 设置图片大小
            self.out1 = self.img1.resize((50, 50), Image.ANTIALIAS)
            # 保存图片，类型为png
            self.out1.save(r"E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像1.png", 'png')
            time.sleep(0.5)  # 给修改图片大小以及保存修改后的图片留时间缓存
            # 把头像转化为PhotoImage
            self.face.append(PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像1.png'))  # 把头像图片加入到列表中
        ...
        # 内容是消息的处理
            ...
            time.sleep(0.5)
            # 打开图片
            self.img2 = Image.open("E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像.png")
            # 设置图片大小
            self.out2 = self.img2.resize((50, 50), Image.ANTIALIAS)
            # 保存图片，类型为png
            self.out2.save(r"E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像2.png", 'png')
            time.sleep(0.5)
            self.face.append(PhotoImage(file='E:\\third\\Digital authentication\\test\\pythonProject-main\\2\\pythonProject-main\\python_chat\\用户头像2.png'))
